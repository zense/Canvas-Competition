...
canvas.setDrawMode = function(mode = "stroke") {
    this.drawMode = (mode === "fill")? "fill" : "stroke";canvas.drawRectangle(1000, 1000, 1000, 500);
};
...
canvas.drawarc=function(x1,y1,r,angle_begin,angle_end)
{
    this.ctx.beginPath();
    this.ctx.arc(x1, y1, r,angle_begin,angle_end);
    this.draw();
}
...
function main()
{
    canvas.drawRectangle(300, 200, 100, 50);
}